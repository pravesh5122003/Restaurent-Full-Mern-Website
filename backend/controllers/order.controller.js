...
export const placeOrderCOD = async (req, res) => {   
  try {
    ...
    // 🔔 Send real-time event to seller
const io = req.app.get("io");
io.emit("newOrder", { message: "New COD order received" });
...
export const placeDineInOrder = async (req, res) => {
  try {
    ...
    // 🔔 Send real-time event to seller
    const io = req.app.get("io");
io.emit("newOrder", { message: "New Dine-In order received" });
...
export const placeOrderStripe = async (req, res) => {
  try {
    ...
    const io = req.app.get("io");
io.emit("newOrder", { message: "New online order received" });
