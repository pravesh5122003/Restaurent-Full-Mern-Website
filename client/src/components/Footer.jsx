...
//   return (
//     <div className="text-gray-500/80 pt-1 px-3 md:px-16 lg:px-24 xl:px-32"> {/* reduced top padding from pt-8 → pt-4 */}

//       {/* Main wrapper */}
//       <div className="flex flex-col items-center text-center gap-12 md:gap-8">
        
//         {/* Brand + Socials */}
//         <div className="max-w-80">
//           <h1 className="text-3xl font-semibold text-[#212121]">Custom restro</h1>
//           <p className="text-sm">
//             Custom Restro blends tradition and taste, serving freshly prepared
//             pizzas, gourmet burgers, and satisfying meals that bring comfort and joy.
//           </p>

//           {/* Social icons (big on desktop) */}
//           <div className="flex justify-center gap-6 mt-6">
//             {/* Instagram */}
//             <a
//               href="https://www.instagram.com/custom_pizza12?igsh=MXBmemN5cHo0bnEwMw=="
//               target="_blank"
//               rel="noopener noreferrer"
//             >
//               <svg
//                 className="w-8 h-8 md:w-10 md:h-10 text-pink-500 hover:text-pink-600 transition"
//                 fill="currentColor"
//                 viewBox="0 0 24 24"
//               >
...
//             {/* WhatsApp */}
//             <a
//               href="https://wa.me/918953573714"
//               target="_blank"
//               rel="noopener noreferrer"
//             >
//               <svg
//                 className="w-8 h-8 md:w-10 md:h-10 text-green-500 hover:text-green-700 transition"
//                 fill="currentColor"
//                 viewBox="0 0 27 24"
//               >
...
//             {/* Call */}
//             <a href="tel:+918953573714">
//               <svg
//                 className="w-8 h-8 md:w-10 md:h-10 text-green-600 hover:text-green-800 transition"
//                 fill="currentColor"
//                 viewBox="0 0 24 24"
//               >
...
//             {/* Location */}
//             <a
//               href="https://maps.app.goo.gl/hiQkx5appzizzHLb7"
//               target="_blank"
//               rel="noopener noreferrer"
//             >
//               <svg
//                 className="w-8 h-8 md:w-10 md:h-10 text-red-500 hover:text-red-600 transition"
//                 fill="currentColor"
//                 viewBox="0 0 24 24"
//               >
...
//         {/* Restaurant + Support side by side (mobile + desktop) */}
// <div className="flex flex-row justify-between gap-8 md:gap-24 md:justify-center text-left">
//   {/* Restaurant */}
//   <div>
...
//       <li>
//         <a href="https://g.page/r/CWkX5Zy_0IyUEBM/review" target="_blank" rel="noopener noreferrer">
//           Customer Reviews
//         </a>
//       </li>
...
//             Enjoyed your meal? Share the love with a Google review and help more
//             food lovers find us — your support means everything!
//           </p>
...
//                 onClick={() =>
//                   window.open(
//                     "https://g.page/r/CWkX5Zy_0IyUEBM/review",
//                     "_blank"
//                   )
//                 }
...
<div className="max-w-full md:max-w-md lg:max-w-lg mx-auto">
  <h1 className="text-3xl md:text-4xl lg:text-4xl font-semibold text-[#212121]">
    Custom Restro
  </h1>
  ...
  {/* Social icons (big on desktop) */}
  <div className="flex justify-center md:justify-mid gap-8 mt-6">
...
<div className="flex flex-row justify-between gap-8 md:gap-24 md:justify-center text-left">
  ...
  <p className="mt-3 text-sm md:text-base lg:text-lg text-center leading-relaxed">
    Enjoyed your meal? <br />
    Share the love with a Google review <br />
    and help more food lovers find us — your support means everything!
  </p>
  <div className="flex justify-center items-center mt-4 space-x-2">
    {[1, 2, 3, 4, 5].map((star) => (
      <svg
        ...
        className={`w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 cursor-pointer transition-all duration-200 ${
          star <= hoveredStar
            ? "text-[#D4AF37] scale-110"
            : "text-[#FFD580]"
        }`}
...
//        {/* Brand + Socials + Menu button side by side on desktop */}
//        <div className="flex flex-col md:flex-row md:justify-start md:gap-54 md:items-start gap-12">
...
//         {/* Restaurant + Support side by side (mobile + desktop) */}
// <div className="flex flex-row justify-between gap-16 md:gap-40 md:justify-center text-left">

// {/* Restaurant */}
// <div>
//   <p className="text-lg text-gray-800 md:text-xl lg:text-2xl">MY RESTAURANT</p>
//   <ul className="mt-3 flex flex-col gap-2 text-sm md:text-base lg:text-lg">
//     <li><a href="/about">About Us</a></li>
//     <li>
//       <a href="/menu1.jpg" target="_blank" rel="noopener noreferrer">
//         View Our Menu
...
// {/* Support */}
// <div>
//   <p className="text-lg text-gray-800 md:text-xl lg:text-2xl">SUPPORT</p>
//   <ul className="mt-3 flex flex-col gap-2 text-sm md:text-base lg:text-lg">
//     <li><a href="#">Help Center</a></li>
//     <li><a href="#">Safety Information</a></li>
//     <li><a href="#">Cancellation Options</a></li>
